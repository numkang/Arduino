...
void SerialPrintText(){
  ...
  //Print(0,"ACC2: ");    PrintTab(0); Print(0,accRAW2[ROLL]);    PrintTab(0); Print(0,accRAW2[PITCH]);   PrintTab(0); Println(0,accRAW2[YAW]);
  //Print(0,"MAG: ");    PrintTab(0); Print(0,magRAW[ROLL]);    PrintTab(0); Print(0,magRAW[PITCH]);   PrintTab(0); Println(0,magRAW[YAW]);
  //Print(0,"mcal: ");    PrintTab(0);Print(0,mcal[ROLL]); PrintTab(0); Print(0,mcal[PITCH]);   PrintTab(0); Println(0,mcal[YAW]);
  Print(0,"Signal Strength: ");  PrintTab(0); Print(0,sensorVal); PrintTab(0); Print(0,map(sensorVal,0,1023,0,100)); Println(0," %"); 
  Print(0,pitch_check); PrintTab(0); Print(0,yaw_check); PrintTab(0); Print(0,yaw_init); PrintTab(0); Println(0,sTime); 
  Println(0);
}
