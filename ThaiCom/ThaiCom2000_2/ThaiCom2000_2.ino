...
//////////////////////////////////////////////////////////////////////////////
//MPU6050
#define ACC_ORIENTATION2(X, Y, Z)  {accRAW2[ROLL]  = -X; accRAW2[PITCH]  = -Y; accRAW2[YAW]  =  Z;}
...
static uint16_t calibratingA = 400, calibratingA2 = 400;
static int16_t accRAW[3], accRAW2[3], accSmooth[3];
