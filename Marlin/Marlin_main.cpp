...
#include <hx711.h>
//Thanakorn
#define Pin_dout 25 //13 //EXP1:PB5
#define Pin_slk 26 //37 //EXP1:PB6
#define avg_num 100
...
//  SERIAL_PROTOCOLPGM(" Ratio: ");
//  SERIAL_PROTOCOL(force_ratio);      
//  SERIAL_PROTOCOLPGM(" Val: ");
//  SERIAL_PROTOCOL(val);
//  SERIAL_PROTOCOLPGM(" , ");
//  SERIAL_PROTOCOL(val2);
//  SERIAL_PROTOCOLPGM(" Offset: ");
//  SERIAL_PROTOCOL(force_offset); 
//  SERIAL_PROTOCOLPGM(" Gram: ");
//  SERIAL_PROTOCOL(gram);
//  delay(200);
